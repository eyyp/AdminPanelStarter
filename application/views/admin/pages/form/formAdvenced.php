    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                ...
                <p class="sub-title">Fancy and customizable colorpicker plugin for Twitter Bootstrap.</p>
                <form action="#">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="sub-title">This plugin integrates by default with Twitter bootstrap using badges to display the maximum lenght of the field where the user is inserting text. </p>
                <?php 
                    $this->load->view(component('form','elements'),[
                        'name'=>'tesdf',
                        'title'=>'Title asd',
                        'textLabel'=>'The badge will show up by default when the remaining chars are 10 or less:',
                        'type'=>'text',
                    ]) ?>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="form-datepicker">
