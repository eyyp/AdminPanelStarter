...
<div class="form-group">
    ...
    <?php if(isset($label)) { ?><label <?php if(isset($id)){ echo 'for="'.$id.'"'; }?>><?php echo $label ?></label><?php }?>
    <div>
        <div class="custom-control custom-checkbox">
            <input type="checkbox" <?php if(isset($name)) { echo 'name='.$name; }?> class="custom-control-input" <?php if(isset($id)){ echo 'id="'.$id.'"';}?> data-parsley-multiple="groups" data-parsley-mincheck="2">
