    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                ...
                <p class="sub-title">For basic styling—light padding and only horizontal dividers—add the base class <code>.table</code> to any
                    <code>&lt;table&gt;</code>.
                </p>
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                ...
                <p class="sub-title">Add <code>.table-bordered</code> for borders on all sides of the table and cells.
                </p>
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                ...
                <p class="sub-title">Your awesome text goes here.</p>
